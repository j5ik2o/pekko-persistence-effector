...
object Dependencies {
  ...
  object circe {
    val core = "io.circe" %% "circe-core" % "0.14.14"
    val generic = "io.circe" %% "circe-generic" % "0.14.14"
    val parser = "io.circe" %% "circe-parser" % "0.14.14"
  }

  object airframe {
    val ulid = "org.wvlet.airframe" %% "airframe-ulid" % "2025.1.17"
  }
