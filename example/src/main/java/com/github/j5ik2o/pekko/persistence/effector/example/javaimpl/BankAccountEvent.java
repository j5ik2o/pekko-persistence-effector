...
public sealed interface BankAccountEvent extends Serializable {
   ...
   */
  record Created(BankAccountId aggregateId, Money limit, Money balance, Instant occurredAt)
   ...
   * @param occurredAt Occurrence time
   */
  record CashDeposited(BankAccountId aggregateId, Money amount, Instant occurredAt)
      implements BankAccountEvent {
    @Override
    public BankAccountId getAggregateId() {
      return aggregateId;
   ...
   * @param occurredAt Occurrence time
   */
  record CashWithdrew(BankAccountId aggregateId, Money amount, Instant occurredAt)
      implements BankAccountEvent {
    @Override
    public BankAccountId getAggregateId() {
      return aggregateId;
