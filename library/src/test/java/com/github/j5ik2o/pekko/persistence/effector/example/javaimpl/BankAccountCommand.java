...
public sealed interface BankAccountCommand {
   ...
   */
  record GetBalance(BankAccountId aggregateId, ActorRef<GetBalanceReply> replyTo)
   ...
   * @param replyTo Reply destination
   */
  record Stop(BankAccountId aggregateId, ActorRef<StopReply> replyTo)
      implements BankAccountCommand {
    @Override
    public BankAccountId getAggregateId() {
      return aggregateId;
   ...
   * @param replyTo Reply destination
   */
  record Create(BankAccountId aggregateId, ActorRef<CreateReply> replyTo)
      implements BankAccountCommand {
    @Override
    public BankAccountId getAggregateId() {
      return aggregateId;
   ...
   * @param replyTo Reply destination
   */
  record DepositCash(BankAccountId aggregateId, Money amount, ActorRef<DepositCashReply> replyTo)
      implements BankAccountCommand {
    @Override
    public BankAccountId getAggregateId() {
      return aggregateId;
   ...
   * @param replyTo Reply destination
   */
  record WithdrawCash(BankAccountId aggregateId, Money amount, ActorRef<WithdrawCashReply> replyTo)
      implements BankAccountCommand {
    @Override
    public BankAccountId getAggregateId() {
      return aggregateId;
   ...
   * @param state State
   */
  record StateRecovered(BankAccountAggregate.State state)
      implements BankAccountCommand,
          RecoveredState<BankAccountAggregate.State, BankAccountCommand> {
    @Override
    public BankAccountId getAggregateId() {
   ...
   * @param events Events
   */
  record EventPersisted(List<BankAccountEvent> events)
      implements BankAccountCommand, PersistedEvent<BankAccountEvent, BankAccountCommand> {
    @Override
    public BankAccountId getAggregateId() {
   ...
   * @param state State
   */
  record StatePersisted(BankAccountAggregate.State state)
      implements BankAccountCommand,
          PersistedState<BankAccountAggregate.State, BankAccountCommand> {
    @Override
    public BankAccountId getAggregateId() {
   ...
   */
  record SnapshotShotsDeleted(long maxSequenceNumber)
      implements BankAccountCommand, DeletedSnapshots<BankAccountCommand> {
    @Override
    public BankAccountId getAggregateId() {
